...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cargarPeliculas()
        var listView: GridView = findViewById(R.id.gridview) as GridView
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Leapy Year", R.drawable.leapyear, R.drawable.leapyearheader, "A woman who has an elaborate scheme to propose to her boyfriend on Leap Day, an Irish tradition which occurs every time the date February 29 rolls around, faces a major setback when bad weather threatens to derail her planned trip to Dublin. With the help of an innkeeper, however, her cross-country odyssey just might result in her getting engaged.\n"))
...
class PeliculaAdapter: BaseAdapter {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        var vista = inflator.inflate(R.layout.activity_detalle_pelicula, null)
        vista.iv_pelicula_imagen.setImageResource(pelicula.image)
        vista.tv_pelicula_nombre.setText(pelicula.header)
